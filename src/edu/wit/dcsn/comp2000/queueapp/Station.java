...
public final class Station {
    ...
    public Queue<Passenger> enterStation(Passenger newPassenger) {
        /*
        TODO: Check to see where the passenger is coming from
        and where they are going to
        Ask TrainRoute which direction the passenger needs to go
         */
        Queue<Passenger> boardingPlatformQueue = platforms.get(this.location.getRoute().whichDirection(newPassenger.getFrom(), newPassenger.getTo()));
        boardingPlatformQueue.add(newPassenger);

        return boardingPlatformQueue;
